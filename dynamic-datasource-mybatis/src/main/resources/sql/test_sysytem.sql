...
-- ----------------------------
INSERT INTO `sys_tenant_data` VALUES (1, 1, 'jdbc:mysql://localhost:3306/tenant_one?tinyInt1isBit=false&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8&allowMultiQueries=true', 'root', 'admin123', NULL, NULL, 0);
INSERT INTO `sys_tenant_data` VALUES (2, 2, 'jdbc:mysql://localhost:3306/tenant_tow?tinyInt1isBit=false&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8&allowMultiQueries=true', 'root', 'admin123', NULL, NULL, 0);
INSERT INTO `sys_tenant_data` VALUES (3, 3, 'jdbc:mysql://localhost:3306/tenant_three?tinyInt1isBit=false&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8&allowMultiQueries=true', 'root', 'admin123', NULL, NULL, 0);
